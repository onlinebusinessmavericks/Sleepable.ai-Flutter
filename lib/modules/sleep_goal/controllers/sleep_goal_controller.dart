...
class SleepGoalController extends GetxController with GetTickerProviderStateMixin {
  ...
  // final List<Map<String, dynamic>> questions = [
  //   {'type': 'time_picker', 'title': '${Get.context?.lang.whatTimeDidYouWakeUpToday}', 'key': 'wake_up_time', 'multiSelect': true},
  //   {'type': 'time_picker', 'title': '${Get.context?.lang.whatTimeDidYouGoToBedLastNight}', 'key': 'sleep_time', 'multiSelect': true},
  //   {
  //     'title': '${Get.context?.lang.howMuchSleepDoYouUsuallyGetAtNight}',
  //     'subtitle': '',
  //     'items': [
  ...
  //   // {
  //   //   'type': 'interstitial',
  //   //   'title': 'Find out what you did in your sleep!',
  //   //   'subtitle': 'Based on data feedback, the Sleepable.ai program has helped users sleep better for billions hours. Our behavioral therapy-based Program is supported by clinical evidence and is the gold standard for better sleep.',
  //   //   'image': Assets.homeSuperPrize,
  //   //   'buttonText': 'Continue',
  //   //   'multiSelect': false
  //   // }, {
  //   //   'type': 'interstitial',
  //   //   'title': 'Sleepable tech brings you expert sleep track & analysis',
  //   //   'subtitle': 'Based on data feedback, the Sleepable.ai program has helped users sleep better for billions hours. Our behavioral therapy-based Program is supported by clinical evidence and is the gold standard for better sleep.',
  //   //   'image': Assets.homeSuperPrize,
  //   //   'buttonText': 'Continue',
  //   //   'multiSelect': false
  //   // }, {
  //   //   'type': 'interstitial',
  //   //   'title': 'Customized white noise helps you fall asleep faster',
  //   //   'subtitle': 'Based on data feedback, the Sleepable.ai program has helped users sleep better for billions hours. Our behavioral therapy-based Program is supported by clinical evidence and is the gold standard for better sleep.',
  //   //   'image': Assets.homeSuperPrize,
  //   //   'buttonText': 'Continue',
  //   //   'multiSelect': false
