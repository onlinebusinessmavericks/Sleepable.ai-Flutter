...
// //
// //   SleepQualityResponse({required this.success, required this.data});
// //
...
// //
// //   SleepQualityWrapper({required this.breakdown});
// //
...
//   factory SleepQualityWrapper.fromJson(Map<String, dynamic> json) {
//     return SleepQualityWrapper(
//       // Parsing 'today' specific keys or defaulting to summary if weekly
//       sleepScore: (json['sleep_score'] ?? json['summary']?['avg_quality_score'] ?? 0.0).toDouble(),
//       durationScore: (json['duration_score'] ?? 0.0).toDouble(),
//       environmentScore: (json['environment_score'] ?? 0.0).toDouble(),
//       sleepPhasesScore: (json['sleep_phases_score'] ?? 0.0).toDouble(),
//       timeInBed: json['time_in_bed'] ?? "--",
//       timeAsleep: json['time_asleep_minutes']?.toString() ?? "0",
//       breakdown: (json['breakdown'] as List? ?? [])
//           .map((e) => SleepQualityPoint.fromJson(e))
//           .toList(),
//     );
