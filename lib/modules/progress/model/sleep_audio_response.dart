...
//
//   SleepAudioResponse({required this.success, required this.message, required this.data});
//
...
//
//   AudioCategoryData({required this.audioType, required this.data});
//
...
//         // 🔥 Use num and cast to double to prevent type errors
...
//   final String emoji;
//   final Color bgColor;
//   final List<AudioItem> recordings; // 🔥 MUST be List<AudioItem>
//   bool isExpanded;
//
//   RecordingCategory({
//     required this.title,
